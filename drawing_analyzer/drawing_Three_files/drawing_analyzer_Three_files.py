...
if __name__ =='__main__':
    file_path_1 = 'train_log_N3.txt'
    file_path_2 = 'train_log_N1.txt'
    file_path_3 = 'train_log_N5.txt'
    ...
    y_re_dict_1['decision_prediction_list_N3']=r'decision_prediction: ([\d\.]+)'
    y_datas_dict_1 = get_parameters_list(path = file_path_1 ,re_dict= y_re_dict_1)

    #file_path_2
    y_re_dict_2 = OrderedDict()
    y_re_dict_2['net_N1_list'] = r'net1: ([\d\.]+)'
    y_datas_dict_2 = get_parameters_list(path = file_path_2 ,re_dict= y_re_dict_2)

    #file_path_3
    y_re_dict_2 = OrderedDict()
    y_re_dict_2['decision_prediction_list_N5']=r'decision_prediction: ([\d\.]+)'
    y_datas_dict_3 = get_parameters_list(path=file_path_3, re_dict=y_re_dict_2)
    ...
    x_datas_dict = get_parameters_list(path = file_path_1 ,re_dict= x_re_dict)
    ...
    y_datas_legend_dict['decision_prediction_list_N3']="N3_final_predict"
