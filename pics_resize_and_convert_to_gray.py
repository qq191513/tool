...
def create_new_route(file,size,resize_pic,convert_to_gray):
...
def resize_pic_and_save(file,size= 32,resize_pic = True,convert_to_gray =True):
    new_route, file_name = create_new_route(file,size,resize_pic,convert_to_gray)
...
for file in files_list:
    resize_pic_and_save(file,size= 32,resize_pic = True,convert_to_gray = True)
